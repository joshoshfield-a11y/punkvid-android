...
/**
 * VIDEOBYTE: Native Edition — WebView shell (Phase 0/1 per spec v2.0).
 * Loads the JS visual engine from assets and provides the native bridge:
 *  - PunkVidNative.saveVideo(base64, filename)  → MediaStore Movies/VIDEOBYTE
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.addJavascriptInterface(new VideoByteBridge(), "VideoByteNative");
    ...
    class VideoByteBridge {
        ...
        public void saveVideo(String base64, String filename) {
            try {
                ...
                runOnUiThread(() -> Toast.makeText(MainActivity.this,
                        "Saved " + name + " to Movies/VIDEOBYTE", Toast.LENGTH_LONG).show());
        ...
        public void shareLast() {
            ...
            runOnUiThread(() -> {
                ...
                startActivity(Intent.createChooser(share, "Share VIDEOBYTE"));
            });
        }
    }
}
